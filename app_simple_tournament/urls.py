...
urlpatterns = [
    ...
    path('tournament/<int:tournament_id>/get_player_for_bracket/', views.get_player_for_bracket, name='get_player_for_bracket'),
    path('tournament/<int:tournament_id>/generate_round/', views.generate_round_pairings, name='generate_round_pairings'),
    path('tournament/<int:tournament_id>/generate_random_pairings/', views.generate_random_pairings, name='generate_random_pairings'),
